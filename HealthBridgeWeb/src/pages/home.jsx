    ...
    <>
      ...
      <div className="headTopic">
        <div className="homeTopic">
          <h1 className="topic">
            Investing in Wellness, Building Healthier Futures
          </h1>
        </div>
      </div>
      ...
      <div className="btn">
        ...
        <button className="subscribeBtn">
          <Link to="/subscribe" className="donation-link">
            Subscribe Now
          </Link>
        </button>
      </div>
      ...
      <div className="discription">
        <div className="dis">
          ...
          <p className="disPar">
            HealthBridge.lk is a trusted, secure, and completely free online
            fundraising platform designed for impact. We connect compassionate
            individuals to vital causes, empowering you to take immediate and
            effective action and enrich lives across Sri Lanka through easy,
            transparent giving.
          </p>
          <MenuLinks
            linkname="Learn More"
